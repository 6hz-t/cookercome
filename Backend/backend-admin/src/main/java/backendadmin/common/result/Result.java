package backendadmin.common.result;

import backendadmin.common.constant.ResultCodeConstant;
...
public  class Result<T> {
    ...
    * */
    ...
    public static Result<User> error(String message) {
        return new Result<>("校验失败");
    }
}